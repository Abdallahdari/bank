...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const diplay_date=`${day}/${month}/${year}`
    const html = `
    ...
    <div class="movements__date">${diplay_date}</div>
...
const brithDay=new Date(1999,4-1,5)
...
// console.log(brithDay.toISOString()) ;
...
// const birthdayString = '2001-12-26';
...
// const dayOfWeekIndex = birthday.getDay();
